...
def main(args=None):
    ...
    sampler_train = AspectRatioBasedSampler(dataset_train, batch_size=2, drop_last=False)
    ...
    if args.use_gpu:
        retinanet = nn.DataParallel(retinanet, device_ids=args.device_ids).cuda()
    ...
    for epoch_num in range(args.epochs):
        ...
        for iter_num, data in enumerate(dataloader_train):
            try:
                ...
                nn.utils.clip_grad_norm_(retinanet.parameters(), 0.1)     # 梯度的最大范数为0.1
